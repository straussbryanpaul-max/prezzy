...
export default function ExecPlan({ onRedactChange }) {
  return (
    <Card slideId="exec_plan" title="Execution Plan Summary" num="02.001" onRedactChange={onRedactChange}>
      <Guidance>Execution strategy including engineering, construction, project controls, procurement, contracts and startup.</Guidance>
      <EditableChunk id="exec_plan:table" label="Execution function table">
        <table className="data-table">
          ...
          <tbody>
            ...
            <tr><td><strong>Engineering</strong></td><td><TextArea name="exec_eng" placeholder="Engineering office, approach..." /></td></tr>
            <tr><td><strong>Procurement</strong></td><td><TextArea name="exec_proc" placeholder="MPAGs, Global Supply Network, local procurement..." /></td></tr>
            <tr>
            ...
            <tr><td><strong>Startup</strong></td><td><TextArea name="exec_startup" placeholder="Startup support, local hires, shared personnel..." /></td></tr>
            <tr><td><strong>Management</strong></td><td><TextArea name="exec_mgmt" placeholder="PM duration, business management, schedule transfer..." /></td></tr>
          </tbody>
        </table>
      </EditableChunk>
